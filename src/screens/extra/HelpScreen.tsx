        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <ScrollView contentContainerStyle={[styles.subContainer, { backgroundColor: colors.background }]}>
                ...
                <Text style={[styles.text, { color: colors.text, fontWeight: typography.fontWeights.regular }]}>
                    Estaremos encantados de acompañarte y brindarte el soporte que necesites. Nuestro objetivo es que tu experiencia sea lo 
                    más clara y positiva posible. Estamos aquí para ayudarte en cada paso del camino.
                    Por favor, no dudes en contactarnos a través del siguiente correo:
                </Text>
                <Text style={[styles.text, { color: colors.text, fontWeight: typography.fontWeights.bold }]}>
                    soporte@trustthreads.com
                </Text>
                <Text style={[styles.text, { color: colors.text, fontWeight: typography.fontWeights.regular }]}>
                    Te brindaremos el apoyo lo más pronto posible. Para una mejor atención, te pedimos evitar el envío de correos repetitivos.
                </Text>
            </ScrollView>
        </View>
    );
