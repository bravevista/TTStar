      ...
      >
        <View style={styles.headerContainer}>
          <View style={styles.header}>
            ...
            >
              ¡Ayudanos a ser mejor para ti!
            </Text>
            <Text style={[{ color: colors.textSecondary }]}>
              Tu opinión cuenta. ¿Notaste un error? ¿Tienes una idea o
              sugerencia?
            </Text>
            <Text style={[{ color: colors.textSecondary }]}>
              Este espacio es para ti: cuéntanos qué funciona, qué no, y qué te
              gustaría ver. Cada mensaje nos ayuda a hacer una app mejor para
              todos. ¡Gracias!
            </Text>
          </View>
        </View>
            ...
            >
              <Text
                style={[
                  ...
                  selectedCategory === cat && { color: colors.background },
                ]}
              >
                {cat}
              </Text>
        ...
        <TouchableOpacity
          onPress={pickImage}
          style={[styles.imageButton, { borderColor: colors.textSecondary }]}
        >
          <MaterialIcons
