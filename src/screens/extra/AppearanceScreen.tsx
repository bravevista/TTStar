      ...
      >
        ...
        >
          ...
          >
            <Feather
              name={
                (themeOptions.find(opt => opt.key === themeMode)
                  ?.icon as any) ?? 'settings'
              }
              size={moderateScale(20)}
              color={colors.text}
            />
            <Text style={[{ color: colors.text }]}>
              {themeOptions.find(opt => opt.key === themeMode)?.label as string}
            </Text>
            <Entypo
              name={themePickerOpen ? 'chevron-up' : 'chevron-down'}
              size={moderateScale(20)}
              color={colors.text}
            />
          </TouchableOpacity>
        ...
        <View
          style={[
            styles.colorPrimaryContainer,
            { borderColor: colors.textSecondary },
            pickerOpen ? styles.modeOne : styles.modeTwo,
          ]}
        >
          <Text
            style={[
              ...
              {availableColors.map(color => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    tempColor === color && styles.selectedOption,
                  ]}
                />
              ))}
            </View>
