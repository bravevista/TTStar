...
import { View, Text, StyleSheet, TextInput, StatusBar, TouchableOpacity, ActivityIndicator, Modal } from 'react-native';
...
export default function LoginScreen({ navigation, route }: ScreenProps<'Login'>) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <Button title='Iniciar sesión' onPress={handleSubmit(handleHome)} disabled={isPending} />
            
            <View style={styles.otherContainer}>
                <Text style={{ color: colors.text }} selectable >¿No tienes una cuenta? </Text>
                <Text style={[styles.forgotPassword, { color: colors.secondary }]} onPress={handleWelcome} >
                    Registrate aquí
                </Text>
            </View>
